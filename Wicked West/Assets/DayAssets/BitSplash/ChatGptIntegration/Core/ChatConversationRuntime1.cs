...
{
    public abstract class RateGPTConversation : ChatGPTConversation
    {

        // ! Not working either....
        /*
        public static RateGPTConversation Start(MonoBehaviour b)
        {
            return new ChatConversationRuntime(ChatGPTConversation); // Was b
        }
        */

        // ! [ChatConversationRuntime class]:
        //! From other inherited class which compiled when made public abstract
        /* 
        ...
        public RateGPTConversation(MonoBehaviour b)
            :base()
        {
            mBehviour = b;
        }
